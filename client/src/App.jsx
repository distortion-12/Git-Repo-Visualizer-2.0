...
function App() {
  ...
  return (
    <div className="visualizer-view two-col" style={{ position:'relative', gridTemplateColumns: panelOpen ? `1fr ${sidebarWidth}px` : '1fr' }}>
      ...
      <div className="vis-container" onMouseMove={(e)=>{
        const r = e.currentTarget.getBoundingClientRect();
        const cx = (e.clientX - r.left)/r.width - 0.5;
        const cy = (e.clientY - r.top)/r.height - 0.5;
        setTilt({ rx: cy*6, ry: -cx*6 });
       }} onMouseLeave={()=>setTilt({rx:0,ry:0})} style={{ perspective:'1200px' }}>
